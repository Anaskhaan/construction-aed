export const data = [
  ...
  },
  {
    ...
    li1: () => (
      <h1>
        ...
        mortar, and reinforcement materials. BidWorks Estimating helps you
        choose the right materials based on your project’s aesthetic and
    ...
    li2: () => (
      <h1>
        ...
        complexity of the project. BidWorks Estimating ensures accurate labor
        cost projections, accounting for project size and design intricacies{" "}
      </h1>
    ),
    li3: () => (
      <h1>
        <span className="font-bold">Waste Minimization:</span> Accurate material
        estimates reduce waste and unnecessary spending. BidWorks Estimating
  ...
  },
  {
    ...
    li1: () => (
      <h1>
        ...
        copper, and other metal components. BidWorks Estimating ensures that you
    ...
    li2: () => (
      <h1>
        <span className="font-bold">Labor:</span> Skilled labor costs for
        welding, installation, and assembly of metal components. BidWorks
    ...
    description:
      "Metals Estimating Services cover everything from the procurement of raw materials to the costs of custom metalwork and finishing. With BidWorks Estimating, you’ll receive reliable estimates that allow for precise cost control and project planning.",
  },
...

  {
    ...
    li1: () => (
      <h1>
        ...
        membranes, vapor barriers, and weatherproofing materials. BidWorks
    ...
    li2: () => (
      <h1>
        ...
        and vapor barrier application. BidWorks Estimating provides accurate
        labor cost projections, ensuring energy-efficient installation.{" "}
      </h1>
    ),
    li3: () => (
      <h1>
        ...
        through reduced energy consumption. BidWorks Estimating helps you weigh
        these benefits and choose the most cost-effective solutions.
      </h1>
    ),
    li4: () => (
      <h1>
        ...
        application of protective materials. BidWorks Estimating factors these
...

  {
    ...
    li3: () => (
      <h1>
        ...
        <span className="text-[#0163be] font-bold"> BidWorks Estimating </span>{" "}
        BidWorks Estimating helps you make informed decisions based on energy
        efficiency goals.
      </h1>
    ),
    li4: () => (
    ...
    description:
      " Openings Estimating Services cover a wide range of materials and labor costs associated with the installation of doors, windows, and other openings. BidWorks Estimating ensures that you receive accurate estimates, reducing the risk of costly errors during installation.",
    route: "Opening",
  },
  {
    src2: "/businesswoman.webp",
    ...
    li2: () => (
      <h1>
        ...
        covering application. BidWorks Estimating provides accurate labor cost
  ...
  },
  {
    ...
    li3: () => (
      <h1>
        ...
        and maintenance costs for equipment. BidWorks Estimating provides
        estimates that factor in ongoing maintenance and servicing needs,
  ...
  },
  {
    ...
    li3: () => (
      <h1>
        ...
        delivery. BidWorks Estimating provides detailed estimates that account
        for all customization needs.
      </h1>
    ),
    li4: () => (
      <h1>
  ...
  },
  {
    ...
    li1: () => (
      <h1>
        ...
        concrete, glass panels, or specialty roofing. BidWorks evaluates
  ...
  },
  {
    ...
    li3: () => (
      <h1>
        <span className="font-bold">Maintenance: </span> Long-term operational
        costs for servicing and maintaining conveying systems. BidWorks
...
export const ServicesData = [
  {
    ...
    li4: () => (
      <h1>
        ...
        BidWorks Estimating includes provisions for energy-efficient systems
        like LED lighting, solar power integration, and sustainable HVAC
        systems. These cost factors ensure the systems are cost-effective and
    ...
    li5: () => (
      <h1>
        ...
        BidWorks Estimating accurately calculates the amount of mortar or grout
    ...
    li6: () => (
      <h1>
        ...
        bricks, blocks, and waste mortar. BidWorks Estimating ensures that waste
    ...
    description: () => (
      <>
        <h1>
          MEP estimating services from BidWorks Estimating focus on assessing
          and costing all mechanical, electrical, and plumbing (MEP) systems
          within a construction project. These services are essential for
          accurately understanding the costs of integrating vital
          infrastructure, ensuring that the MEP systems are efficient,
          compliant, and fit for purpose.
        </h1>
        <h1 className=" mt-4">
          By utilizing BidWorks Estimating, you gain a comprehensive view of the
...

  {
    ...
    li3: () => (
      <h1>
        ...
        structural components like beams, columns, and load-bearing walls.
        BidWorks Estimating considers the material quantities, reinforcement
        requirements, and any specialized equipment needed for these heavy-duty
        components.
      </h1>
    ),
    li4: () => (
      <h1>
        ...
        the poured concrete. BidWorks Estimating provides accurate projections
        for all finishing and post-pour treatments.{" "}
      </h1>
    ),
    li5: () => (
      <h1>
        ...
        the reinforcement needed to strengthen the concrete structure. BidWorks
        Estimating includes material and labor costs for form construction and
        rebar placement.{" "}
      </h1>
    ),
    li6: () => (
    ...
    description: () => (
      <>
        <h1>
          Concrete estimating services from BidWorks Estimating focus on
          providing accurate cost assessments for all concrete-related aspects
          of a construction project. These services are essential for estimating
          the costs of concrete work, including foundations, slabs, walls, and
          structural components.{" "}
        </h1>
        <h1 className=" mt-4">
          By utilizing BidWorks Estimating, you can ensure that your concrete
          work is planned and budgeted effectively, minimizing risks and
          avoiding unexpected costs during the project.
        </h1>
      </>
    ),
    route: "CES",
  },
  {
    ...
    description: () => (
      <>
        <h1>
          Painting estimating services from BidWorks Estimating focus on
          providing accurate cost assessments for all painting and coating work
          in a construction project. These services are essential for estimating
          the costs of interior and exterior painting, including surface
  ...
  // 4
  {
    ...
    li2: () => (
      <h1>
        ...
        material quantities, cutting, bending, and installation labor. BidWorks
        Estimating ensures that the exact amount of rebar required for the
        project is accurately calculated and priced.{" "}
      </h1>
    ),
    li3: () => (
      <h1>
    ...
    description: () => (
      <>
        <h1>
          Steel estimating and detailing services from BidWorks Estimating focus
          on providing accurate cost assessments and detailed plans for steel
        ...
        <h1 className=" mt-4">
          By utilizing BidWorks Estimating, you can ensure precise budgeting,
  ...
  //  5//
  {
    ...
    li5: () => (
      <h1>
        ...
        out masonry work safely and efficiently. BidWorks Estimating takes into
    ...
    description: () => (
      <>
        <h1>
          Masonry takeoff services from BidWorks Estimating provide accurate and
        ...
        <h1 className=" mt-4">
          With BidWorks Estimating, you can ensure precise budgeting and
          seamless planning for masonry construction, minimizing the risk of
          over or underestimation and helping your project stay on track.{" "}
        </h1>
      </>
    ),
  },
  // 6
  {
    ...
    li3: () => (
      <h1>
        ...
        including metal or wood studs, tracks, and supports. BidWorks Estimating
    ...
    li5: () => (
      <h1>
        ...
        materials such as ceiling grids, supports, and suspension systems.
        BidWorks Estimating ensures that all ceiling components are included in
    ...
    li6: () => (
      <h1>
        ...
        BidWorks Estimating ensures that the right amount of finishing materials
        and labor are accounted for based on the level of finish required.{" "}
      </h1>
    ),
    li7: () => (
      <h1>
        ...
        sheets, scrap pieces, and other debris. BidWorks Estimating ensures that
    ...
    description: () => (
      <>
        <h1>
          Drywall takeoff services from BidWorks Estimating provide accurate and
        ...
        <h1 className=" mt-4">
          By using BidWorks Estimating, you can ensure precise budgeting,
          minimize material waste, and optimize labor costs for drywall work,
          keeping your project on schedule and within budget.{" "}
        </h1>
      </>
    ),
  },
  // 7
  {
    ...
    li4: () => (
      <h1>
        ...
        products used in exterior walls, roofs, and subflooring. BidWorks
    ...
    li5: () => (
      <h1>
        ...
        features. This includes rafters, trusses, and decking boards. BidWorks
        Estimating calculates the quantities of lumber and associated costs for
        each roofing and decking component.{" "}
      </h1>
    ),
    li6: () => (
      <h1>
    ...
    li7: () => (
      <h1>
        ...
        packaging. BidWorks Estimating includes the costs associated with
        disposal or recycling, ensuring the project stays clean and within
        budget.
      </h1>
    ),
    title3: "Takeoff ",
    ...
    description: () => (
      <>
        <h1>
          Lumber takeoff services from BidWorks Estimating provide accurate and
        ...
        <h1 className=" mt-4">
          By utilizing BidWorks Estimating, you ensure precise budgeting for
          lumber materials and minimize waste, helping to keep your project on
          schedule and within budget while meeting all structural requirements.{" "}
        </h1>
      </>
    ),
  },
  // 8
  {
    ...
    li1: () => (
      <h1>
        ...
        costs. BidWorks Estimating ensures accurate calculations based on site
    ...
    li4: () => (
      <h1>
        ...
        soil stabilization, and drainage installation. BidWorks Estimating
        includes materials like geotextiles, silt fences, drainage pipes, and
        labor costs for implementing effective drainage systems and ensuring the
    ...
    li5: () => (
      <h1>
        ...
        suspension systems. BidWorks Estimating ensures that all ceiling
        components are included in the overall estimate.{" "}
      </h1>
    ),
    li6: () => (
      <h1>
        ...
        such as walkways, patios, or retaining walls. BidWorks Estimating
        includes material and labor costs for grading, soil preparation, and any
    ...
    li8: () => (
      <h1>
        ...
        materials, such as soil, debris, or construction waste. BidWorks
    ...
    description: () => (
      <>
        <h1>
          ...
          provide comprehensive and precise assessments of all site preparation
          and excavation tasks required for a construction project. These
          services are crucial for estimating the quantities and costs of
          materials, labor, and equipment needed for tasks such as excavation,
          grading, trenching, utilities installation, and site stabilization.
        </h1>
        <h1 className=" mt-4">
          With BidWorks Estimating, you can ensure accurate budgeting for
          earthwork and site preparation, minimizing risks of delays and
          unexpected costs throughout the construction process.{" "}
        </h1>
      </>
    ),
  },
