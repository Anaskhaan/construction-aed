...
export const data = [
  {
    ...
    Des1: "With Swift Takeoffs, you’ll have a clear picture of the costs associated with addressing these conditions, minimizing risks, and reducing the chances of unexpected expenses during construction.",
  ...
  },
  {
    ...
    route: "masonary",
    title1: "Masonry",
    Des1: "Masonry Estimating Services cover everything from the selection of masonry materials to the calculation of installation labor. With Swift Takeoffs, you can be confident that your masonry work is thoroughly accounted for, ensuring that your project stays on schedule and within budget.",
    image: "/masonry.svg",
    title2: "Cost Factors",
    li1: () => (
      <h1>
  ...
  },
  {
    ...
    route: "metals",
    title1: "Metals",
    Des1: " Metals estimating services from Swift Takeoffs offer a comprehensive breakdown of the costs associated with metal fabrication and installation, including structural and decorative metalwork. Whether it’s structural steel, aluminum framing, or ornamental railings, Swift Takeoffs provides accurate estimates to ensure efficient budgeting for metal-related components of your construction project. ",
    image: "/metalcon.svg",
    title2: "Cost Factors",
    li1: () => (
      <h1>
    ...
    description:
      "Metals Estimating Services cover everything from the procurement of raw materials to the costs of custom metalwork and finishing. With Swift Takeoffs, you’ll receive reliable estimates that allow for precise cost control and project planning.",
  },

  {
    src2: "/businesswoman.webp",
    title1: "Wood, Plastics,and Composites",
    Des1: "Wood, Plastics, and Composites Estimating Services offer a detailed breakdown of material costs, labor, and installation needs for various wood and composite applications. Whether it’s framing, cabinetry, or decorative features, Swift Takeoffs helps you budget accurately and efficiently. ",
    image: "/wood.svg",
    title2: "Cost Factors",
    li1: () => (
      <h1>
...

  {
    ...
    description:
      "Thermal and Moisture Protection estimating services from Swift Takeoffs are crucial for predicting the costs associated with insulation, waterproofing, and weatherproofing. These services ensure that your project is protected from moisture, air infiltration, and temperature fluctuations while meeting energy efficiency standards",
    route: "Tmp",
  },
...

  {
    ...
    description:
      " Openings Estimating Services cover a wide range of materials and labor costs associated with the installation of doors, windows, and other openings. Swift Takeoffs ensures that you receive accurate estimates, reducing the risk of costly errors during installation.",
    route: "Opening",
  },
  {
    src2: "/businesswoman.webp",
  ...
  },
  {
    ...
    description:
      "Furnishings estimating services from Swift Takeoffs are essential for projecting the costs associated with furniture, fixtures, and accessories in both residential and commercial construction projects. These services ensure that all interior furnishing elements are accounted for in your project’s budget, allowing for efficient planning and procurement.",
    route: "furnishies",
  },
  {
    src2: "/businesswoman.webp",
    title1: "Special Construction ",
    Des1: "Special Construction Estimating Services include a comprehensive breakdown of costs for materials, labor, and equipment needed for unique construction projects. Swift Takeoffs ensures that all special construction elements are accounted for in the financial plan, enabling you to manage even the most complex projects with confidence.",
  ...
  },
  {
    ...
    Des1: "Mechanical Support Estimating Services include a detailed breakdown of costs for materials, labor, and installation of mechanical support systems. With Swift Takeoffs, you can rest assured that all brackets, mounts, and structural supports are accounted for in the project’s financial plan.",
    image: "/Convey.webp",
    title2: "Cost Factors",
    li1: () => (
      <h1>
  ...
  },
  {
    ...
    description:
      "Fire Suppression estimating services from Swift Takeoffs provide detailed cost projections for the installation and maintenance of fire protection systems, including sprinklers, alarms, extinguishers, and other safety equipment. These services ensure that all fire safety requirements are accounted for in the project budget, allowing for compliance with local building codes and safety regulations.",
  ...
  },
  {
    ...
    description:
      "Plumbing estimating services from Swift Takeoffs provide detailed cost projections for the installation of water supply, drainage, and waste systems. These services ensure that all plumbing-related needs are included in the project budget, allowing for efficient installation and long-term operation of water systems.",
    route: "PSE",
  },
  {
    src2: "/businesswoman.webp",
    title1: "Heating, Ventilating, and Air Conditioning Estimating Services",
    Des1: "HVAC Estimating Services include a comprehensive breakdown of costs for HVAC units, ductwork, venting, and related labor, ensuring that all mechanical systems are accounted for in the project’s financial plan. With Swift Takeoffs, you’ll receive accurate estimates that help ensure efficient HVAC installation and energy-efficient operation.",
    image: "/Convey.webp",
    title2: "Cost Factors",
    li1: () => (
      <h1>
  ...
  },
  {
    ...
    description:
      "Earthwork estimating services from Swift Takeoffs provide detailed cost projections for excavation, grading, and site preparation. These services ensure that all earthmoving activities are included in the project budget, allowing for efficient site preparation and foundation work.",
    route: "earthwork",
  },
  {
    src2: "/businesswoman.webp",
    title1: "Exterior Improvements",
    Des1: "Exterior Improvements Estimating Services include a comprehensive breakdown of costs for materials, labor, and equipment needed for landscaping, paving, fencing, and other exterior elements. With Swift Takeoffs, you’ll receive accurate estimates that ensure your project’s outdoor spaces complement the building and meet all functional requirements.",
    image: "/Convey.webp",
    title2: "Cost Factors",
    li1: () => (
      <h1>
  ...
  },
  {
    ...
    description:
      "Utilities estimating services from Swift Takeoffs provide detailed cost projections for the installation of water, sewer, gas, and electrical infrastructure. These services ensure that all necessary utility connections are included in the project budget, allowing for efficient planning and installation.",
    route: "utilities",
  },
];
...
export const servicesData = [
  {
    ...
    image: "/tradesimages/concrete.webp",
  ...
  },
  {
    ...
    image: "/tradesimages/electrical.webp",
  ...
  },
  {
    ...
    image: "/tradesimages/masonry.webp",
  ...
  },
  {
    ...
    image: "/tradesimages/plumbing.webp",
    // link: "#plumbing-service",
  },
  {
...

  {
    ...
    image: "/tradesimages/opening.webp",
    // link: "#plumbing-service",
  },
  {
    ...
    image: "/tradesimages/existing.webp",
    // link: "/plumbing-service",
  },
  {
    ...
    image: "/tradesimages/finieshes.webp",
    // link: "/plumbing-service",
  },
  {
    ...
    image: "/tradesimages/thermal.webp",
    // link: "/plumbing-service",
  },
  {
    ...
    image: "/tradesimages/conveying.webp",
    // link: "/plumbing-service",
  },
];
