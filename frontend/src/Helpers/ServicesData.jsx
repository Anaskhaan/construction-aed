export const ServicesData = [
...

  {
    ...
    route: "RES",
    title1: "Residential Estimating Services",
    Des1: " At Swift Takeoffs, we specialize in providing precise and comprehensive material takeoff services to ensure accurate planning, budgeting, and procurement for construction projects. Our detailed takeoff reports help contractors, builders, and project managers estimate material quantities, reduce waste, and optimize project costs.",
    image: "/S3.webp",
    ...
    li1: () => (
      <h1>
        ...
        <ul>
          <li>
            Excavation & Grading – Costs for site clearing, soil preparation,
            and grading.
          </li>
          <li>
            Soil Stabilization & Retaining Walls – Costs for geotechnical
    ...
    li2: () => (
      <h1>
        ...
        <ul>
          <li>
            Steel & Concrete Structures – Costs for beams, columns, and
            prefabricated structural elements.
          </li>
          <li>
            Framing & Load-Bearing Walls – Estimation of steel framing, wood, or
            reinforced concrete systems.
          </li>
          <li>
            Roofing & Cladding – Costs for commercial-grade roofing systems,
    ...
    li3: () => (
      <h1>
        ...
        <ul>
          <li>
            Partitions & Drywall – Material takeoffs for interior framing and
            wall systems.
          </li>
          <li>
            Flooring Systems – Estimates for tile, carpet, polished concrete,
            and resilient flooring.
          </li>
          <li>
            Ceiling Systems – Cost projections for suspended ceilings, acoustic
    ...
    li4: () => (
      <h1>
        ...
        <ul>
          <li>
            4. HVAC Systems – Estimation of heating, ventilation, and air
            conditioning requirements.
          </li>
          <li>
            Plumbing & Fire Protection – Takeoff for water supply, drainage, and
            fire suppression systems.
          </li>
          <li>
            Electrical & Lighting – Material quantities for wiring,
    ...
    li5: () => (
      <h1>
        ...
        <ul>
          <li>
            Paving & Parking Lots – Costs for asphalt, concrete, and drainage
            infrastructure.
          </li>
          <li>
            Landscaping & Hardscaping – Budgeting for green spaces, irrigation,
            and outdoor amenities.
          </li>
          <li>
            Security & Access Control – Estimates for fencing, gates, and
    ...
    Des3: () => (
      <>
        <ul>
          <li>
            <span>1. Project Review</span> Analyzing architectural and
            structural blueprints to assess material needs.
          </li>
          <li>
            <span>2. Quantity Takeoff</span>Using advanced software to calculate
            accurate material and labor requirements.
          </li>
          <li>
            <span>3. Cost Estimation</span>Assigning unit pricing to all
            materials and labor costs for budget accuracy.
          </li>
          <li>
            <span>4. Quality Assurance</span>Verifying all estimates to
            eliminate errors and ensure cost control.
          </li>
          <li>
            <span>5 . Final Reporting</span>Delivering detailed, easy-to-read
            estimates with itemized cost breakdowns.
          </li>
        </ul>
      </>
    ),
    ...
    description: () => (
      <>
        <p>
          At Swift Takeoffs, we provide accurate and comprehensive residential
          estimating services to help homeowners, contractors, and developers
          plan and budget their projects effectively. Our detailed estimates
          cover all aspects of materials, labor, equipment, and overhead costs,
          ensuring a smooth and cost-efficient construction process.
        </p>
      </>
    ),
  },
...

  {
    ...
    route: "CoES",
    title1: "Commercial Estimating Services",
    Des1: " At Swift Takeoffs, we specialize in providing precise and comprehensive material takeoff services to ensure accurate planning, budgeting, and procurement for construction projects. Our detailed takeoff reports help contractors, builders, and project managers estimate material quantities, reduce waste, and optimize project costs.",
    image: "/S3.webp",
    ...
    li1: () => (
      <h1>
        ...
        <ul>
          <li>
            Excavation & Grading – Estimating earthwork, site clearing, and
            leveling. Foundation Systems – Concrete footings, slabs, pilings,
            and waterproofing materials.
          </li>
          <li>
            Foundation Materials – Concrete, rebar, formwork, and waterproofing
            estimates.
          </li>
          <li>
            Footings & Slabs – Calculations for pier footings, basements, and
    ...
    li2: () => (
      <h1>
        ...
        <ul>
          <li>
            Lumber & Wood Framing – Material takeoffs for studs, beams, and
            joists. Steel & Reinforcement – Costs for load-bearing elements,
            trusses, and engineered beams.
          </li>
          <li>
            Roofing & Sheathing – Estimates for roof framing, decking, and
    ...
    li3: () => (
      <h1>
        ...
        <ul>
          <li>
            Siding & Masonry – Material costs for stucco, brick, stone, or vinyl
            siding.
          </li>
          <li>
            Roofing & Sheathing – Estimates for roof framing, decking, and
    ...
    li4: () => (
      <h1>
        ...
        <ul>
          <li>
            Drywall & Insulation – Calculations for wallboard, insulation, and
            vapor barriers.
          </li>
          <li>
            Flooring Materials – Tile, hardwood, laminate, and carpet estimates.
          </li>
          <li>
            Paint & Coatings – Quantity calculations for primers, paints, and
            sealants.
          </li>
        </ul>
      </h1>
    ...
    li5: () => (
      <h1>
        ...
        <ul>
          <li>
            Plumbing Fixtures & Piping – Costs for water supply, drainage, and
            gas piping.
          </li>
          <li>
            HVAC Systems – Heating, ventilation, and air conditioning material
            estimates.
          </li>
          <li>
            Electrical Wiring & Fixtures – Quantity takeoff for outlets, panels,
    ...
    li6: () => (
      <h1>
        ...
        <ul>
          <li>
            Driveways & Walkways – Concrete, asphalt, or paver material
            takeoffs.
          </li>
          <li>
            Fencing & Outdoor Features – Costs for fencing, decks, patios, and
            retaining walls
          </li>
          <li>
            Irrigation & Planting – Estimates for sod, shrubs, trees, and
            irrigation systems.
          </li>
        </ul>
      </h1>
    ...
    description: () => (
      <>
        <p>
          At Swift Takeoffs, we specialize in accurate and detailed commercial
          estimating services to help contractors, developers, and project
          managers effectively budget and plan large-scale construction
          projects. Our estimates provide a comprehensive breakdown of
          materials, labor, equipment, and overhead costs, ensuring precise
          financial planning and minimizing unexpected expenses.
        </p>
      </>
    ),
  },
...

  {
    ...
    route: "IES",
    title1: "Industrial Estimating Services",
    Des1: " At Swift Takeoffs, we specialize in providing precise and comprehensive material takeoff services to ensure accurate planning, budgeting, and procurement for construction projects. Our detailed takeoff reports help contractors, builders, and project managers estimate material quantities, reduce waste, and optimize project costs.",
    image: "/S3.webp",
