    ...
    <section className="flex flex-col md:flex-row items-center gap-8 px-6 md:px-16 py-12 bg-white">
      ...
      <div className="flex-1  ">
        <h2 className="text-2xl md:text-2xl font-bold text-[#202020]">
          Why Hire <span className="text-[#0163BE]">BidWorks</span> Estimating?
        </h2>
        <p className="text-gray-600 mt-4 text-lg leading-relaxed">
          ...
          Whether you&apos;re managing a large-scale commercial development or a
          residential build, our expert team is here to ensure that your project
          stays on track, on budget, and within scope.
        </p>
