...
//     console.log("Selected Level Type:", event.target.value);
//   };
...
//               </option>
//               <option value="basic">
//                 Level 1 Basic Takeoff(Over All SQ FT/LF & Material Description)
//               </option>
...
const GetQuote = () => {
  const [formData, setFormData] = useState({
    ...
    message: "",
    file: null,
    levelType: "", // Added levelType to form state
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        message: "",
        file: null,
        levelType: "", // Reset levelType after submission
      });
    } catch (error) {
      console.error("Error submitting form:", error);
      toast.error("Failed to submit the form. Please try again.");
